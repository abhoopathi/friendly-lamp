class p8:
    ...
    def get_latest_data(self):
        ...
        # data cleaning
        self.p8_df=df1.toPandas()

        dates_outlook = pd.to_datetime(pd.Series(self.p8_df.time_stamp),unit='ms')
        self.p8_df.index = dates_outlook   
        self.p8_df['date'] = self.p8_df.index.date
        self.p8_df = self.p8_df.sort_values(by='time_stamp')
    ...
    def forcomb(self,s):
        ...
        p8_df = self.get_latest_data()

        temp2 = self.p8_df[self.p8_df.source==s]
